...
var Xnon = "X";
var X = Xnon.fontcolor("white");
var Arr = [myfunc_3,myfunc_4,myfunc_5,myfunc_6,myfunc_7,myfunc_8,myfunc_9,myfunc_10,myfunc_11];
...
//fucntion used to remove selected boxes
function Poper(p){
	var n = Arr.indexOf(p);
	Arr.splice(n,1);
	num = num - 1;
